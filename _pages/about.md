...
<br /><br /><br /><br /><br /><br />
<br /><br />
- **Programming Languages** : Python, C++, C\#, PHP <br />
- **Web Technologies** : HTML, CSS, JavaScript <br />
- **Database Systems**: MySQL <br />
- **Data Science & Machine Learning** : Python, R, CRNN model <br />
- **Research Skills** : Statistical Analysis, Hypothesis Testing, Problem Optimization <br />
- **Other Skills** : Unity, Blender, Autodesk Fushion360 <br />
<br /><br /><br /><br /><br /><br />
<br /><br />
